...
const Chat: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-8 right-8 z-20 w-96">
      <Card className="h-[500px] flex flex-col border-2 border-blue-500 shadow-lg"> {/* Increased size and added blue border */}
          ...
          <div className="flex-1 overflow-y-auto px-4 py-2 space-y-4 scroll-smooth">
            {messages.length === 0 ? (
              <div className="text-center text-muted-foreground text-sm">
                <p>Salut ! Je suis votre assistant IA.</p>
                <p>Posez-moi toutes vos questions sur le travail et le parcours de Youssef !</p>
                {!hasApiKey && (
